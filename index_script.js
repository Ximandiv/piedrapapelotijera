...
const swalGanador = () =>{
    Swal.fire({
        icon: 'success',
        title: 'Me has ganado!',
        text: 'Felicidades, me has ganado.',
...
const swalPerdedor = () =>{
    Swal.fire({
        icon: 'error',
        title: 'Yo gano!',
        text: 'A la próxima quizás me ganes.',
        allowOutsideClick: false,
        allowEscapeKey: false,
        allowEnterKey: false
    })
...
const resul = () =>{
    if(eleccionUsuario == "piedra"){
        if(eleccionComputadora == "piedra"){
            resultado.textContent = "Empatamos!";
            ableToClick();
        }
        if(eleccionComputadora == "papel"){
            resultado.textContent = "Perdiste, hehe.";
            contadorComputadora++;
            puntajeComputadora.textContent = contadorComputadora;
        ...
        if(eleccionComputadora == "tijera"){
            resultado.textContent = "Me has ganado! Bien...";
            contadorUsuario++;
            puntajeUsuario.textContent = contadorUsuario;
            ganadores(puntajeUsuario, puntajeComputadora);
            ableToClick();
